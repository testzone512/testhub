...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 28, 2017 at 10:42 AM
...
(1, 6, 10, 'name ', '3 ', 1, 'Desert.jpg ', 0, 0, '3', 'success', '2016-12-19 07:25:57'),
(2, 6, 13, 'skirts ', '10 ', 1, 'Clothesloop_Website-3.jpg ', 4, 7, '10', 'success', '2016-12-19 07:44:26'),
(3, 6, 11, 'book ', '5 ', 2, 'Clothesloop_Website-5.jpg ', 0, 0, '10', 'success', '2016-12-19 07:44:27'),
(4, 1, 13, 'skirts ', '10 ', 1, 'Clothesloop_Website-31.jpg ', 4, 6, '10', 'pending', '2016-12-21 09:36:45'),
(5, 1, 12, 'pen ', '44 ', 1, 'Clothesloop_Website-4.jpg ', 0, 0, '44', 'pending', '2016-12-21 12:08:22'),
(6, 1, 13, 'skirts ', '10 ', 2, 'Clothesloop_Website-31.jpg ', 4, 7, '20', 'pending', '2016-12-22 11:47:17'),
(7, 1, 13, 'skirts ', '10 ', 1, 'Clothesloop_Website-31.jpg ', 4, 7, '10', 'pending', '2016-12-22 11:52:05'),
(8, 1, 23, 'pant ', '10 ', 1, 'Tulips.jpg ', 0, 0, '10', 'payment failed', '2016-12-22 11:54:26'),
(10, 1, 12, 'pen ', '44 ', 1, 'Clothesloop_Website-4.jpg ', 0, 0, '44', 'pending', '2016-12-22 13:20:59'),
(11, 1, 24, 'beg ', '33 ', 1, 'Chrysanthemum.jpg ', 0, 0, '33', 'pending', '2016-12-22 13:20:59'),
(12, 1, 12, 'pen ', '44 ', 1, 'Clothesloop_Website-4.jpg ', 0, 0, '44', 'pending', '2016-12-22 13:21:18'),
(13, 1, 24, 'beg ', '33 ', 1, 'Chrysanthemum.jpg ', 0, 0, '33', 'pending', '2016-12-22 13:21:18'),
(14, 1, 12, 'pen ', '44 ', 1, 'Clothesloop_Website-4.jpg ', 0, 0, '44', 'pending', '2016-12-22 13:21:56'),
(15, 1, 24, 'beg ', '33 ', 1, 'Chrysanthemum.jpg ', 0, 0, '33', 'pending', '2016-12-22 13:21:56'),
(16, 1, 12, 'pen ', '44 ', 1, 'Clothesloop_Website-4.jpg ', 0, 0, '44', 'pending', '2016-12-22 13:22:18'),
(17, 1, 24, 'beg ', '33 ', 1, 'Chrysanthemum.jpg ', 0, 0, '33', 'pending', '2016-12-22 13:22:18');
...
(7, 3, 'Dresses-Playsuits', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
(1, 14, 'Desert1.jpg', 1),
(5, 14, 'googlebot-1327931529.jpg', 1);
...
(11, 'book', 5, 'Single', 0, '54', 1, 'Clothesloop_Website-51.jpg', '2016-11-28 14:06:32', '2017-01-28 05:05:48'),
(12, 'pen', 4, 'Single', 0, '44', 1, 'Clothesloop_Website-4.jpg', '2016-11-23 00:00:00', '2017-01-25 13:50:45'),
(13, 'skirts', 5, 'Multiple', 0, '10', 1, 'Clothesloop_Website-32.jpg', '2016-11-27 00:00:00', '2016-12-27 15:11:17'),
(14, 'Loose Pleated Pants', 7, 'Multiple', 1, '1', 1, 'Clothesloop_Website-2.jpg', '2016-11-28 00:00:00', '2017-01-26 18:18:06'),
(15, 'Loose Pleated Pants', 4, 'Single', 1, '64', 1, 'Clothesloop_Website-5.jpg', '2016-11-28 00:00:00', '2016-12-27 15:11:00'),
...
(22, 'jackets', 6, 'Single', 5, '33', 1, 'Desert1.jpg', '2016-12-21 09:39:48', '2016-12-27 15:10:24'),
(23, 'pant', 6, 'Single', 4, '10', 1, 'Tulips1.jpg', '2016-12-21 09:40:20', '2016-12-27 15:10:16'),
(24, 'beg', 6, 'Single', 5, '33', 0, 'Chrysanthemum1.jpg', '2016-12-21 09:45:40', '2016-12-27 15:09:47');

-- --------------------------------------------------------

--
-- Table structure for table `product_activation_logs`
--

CREATE TABLE `product_activation_logs` (
  `pal_id` int(11) NOT NULL,
  `pal_product_id` int(11) NOT NULL,
  `pal_user_id` int(11) NOT NULL,
  `pal_action` varchar(12) NOT NULL,
  `pal_reson` varchar(255) NOT NULL,
  `pal_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `product_activation_logs`
--

INSERT INTO `product_activation_logs` (`pal_id`, `pal_product_id`, `pal_user_id`, `pal_action`, `pal_reson`, `pal_date`) VALUES
(10, 10, 1, 'Inactive', 'name ', '2016-11-15 06:52:40');
...
CREATE TABLE `question` (
  ...
  `question_distance` char(10) NOT NULL,
  `question_location` varchar(255) NOT NULL,
  `question_learn_about` char(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `question` (`question_id`, `question_user_id`, `question_distance`, `question_location`, `question_learn_about`) VALUES
(1, 10, '2km', 'Captown', 'I'),
(2, 11, '4km', 'Paras', 'I'),
(3, 12, '4km', 'Kingsman', 'OS'),
(4, 13, '10km', 'Los angles', 'OS'),
(5, 14, '6km', 'call', 'O'),
(6, 4, '', '', ''),
(7, 5, '2km', '', 'FF'),
(8, 6, '2km', '', 'FF'),
...
(1, 6, '10', '3', '50', '53', '2016-12-19 07:25:57'),
(2, 6, '13,11', '20', '50', '70', '2016-12-19 07:44:27'),
(3, 1, '13', '10', '50', '60', '2016-12-21 09:36:45'),
(4, 1, '12', '44', '50', '94', '2016-12-21 12:08:22'),
(5, 1, '13', '20', '50', '70', '2016-12-22 11:47:17'),
(6, 1, '13', '10', '50', '60', '2016-12-22 11:52:05'),
(7, 1, '23', '10', '50', '60', '2016-12-22 11:54:26'),
(8, 1, '11', '54', '50', '104', '2016-12-22 13:12:11');
...
INSERT INTO `temp_cart` (`tc_id`, `tc_user_id`, `tc_product_id`, `tc_product_name`, `tc_product_price`, `tc_product_qty`, `tc_product_img`, `tc_product_colour`, `tc_product_size`, `tc_product_total`) VALUES
(4, 1, 12, 'pen ', '44 ', 3, 'Clothesloop_Website-4.jpg ', 0, 0, '132'),
(5, 1, 11, 'book ', '54 ', 2, 'Clothesloop_Website-51.jpg ', 0, 0, '108');
...
CREATE TABLE `users` (
  ...
  `user_garment_id` varchar(255) NOT NULL,
  `user_is_admin` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 = No, 1 = Yes',
  `user_activation_pending` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 = No, 1 = Yes',
  `is_launch` int(11) NOT NULL DEFAULT '0' COMMENT '0 = No, 1 =Yes',
...
INSERT INTO `users` (`user_id`, `user_firstname`, `user_lastname`, `user_introduction`, `user_profile_pic`, `user_mobile`, `user_address`, `user_address2`, `user_email`, `user_password`, `user_country_id`, `user_state_id`, `user_city_id`, `user_postcode`, `user_garment_id`, `user_is_admin`, `user_activation_pending`, `is_launch`, `is_subscribe`, `user_created_on`, `user_updated_on`) VALUES
(1, 'John', 'Dawn', 'Lorem ipsum dolor sit amet, enim noster explicari ne eam, recteque argumentum vel in. Graeci melius ut eam, te vis duis maiestatis adipiscing, diceret accusamus sed ea. Sed an nulla semper eirmod, pri ad graece labore luptatum, volutpat expetenda ne mea. Tota graece consetetur vim ei, mea ut tation decore soluta. Te est idque quaeque senserit, an per harum ignota insolens. Habemus suscipit te vis, quot quas assentior cum ex, te euripidis disputationi vix. Ex pri veritus adipiscing.', 'Lighthouse.jpg', '7878787878', '4975 Cambridge Road Miami Gardens, FL 33056 ', '', 'admin@gmail.com', 'MTIzNDU2', 9, 108, 693, '', '', 1, 1, 0, 0, '2016-11-15 00:00:00', '0000-00-00 00:00:00'),
(6, 'james', 'villiam', '', '', '', 'wall street', '', 'testzone512@gmail.com', 'MTIzNDU2', 1, 0, 0, '36563', '2', 0, 1, 1, 1, '2016-12-16 05:18:16', '2016-12-19 06:27:19'),
(7, 'james', 'zone', '', '', '', 'katargam', '44', 'admin@gmail.com', 'MTIzNDU2', 8, 0, 0, 'admin@gmai', 'd', 0, 0, 1, 1, '2016-12-30 12:20:25', '0000-00-00 00:00:00');
...
--
-- Indexes for table `product_activation_logs`
--
ALTER TABLE `product_activation_logs`
...
--
-- AUTO_INCREMENT for table `product_activation_logs`
--
ALTER TABLE `product_activation_logs`
  MODIFY `pal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
