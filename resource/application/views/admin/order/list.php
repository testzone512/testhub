                    ...
                    <table class="table table-bordered" id="orderData">
                        ...
                        <?php foreach ($orderDetails as $order) { ?>
                            <tr>
                                ...
                                <td><?php echo get_product_name($order['sc_product_id']); ?></td>
                                ...
                                <td>
                                    <a href="<?php echo site_url('admin/order/view/' . $order["sc_id"]); ?>"><i class="fa fa-eye fa-2x" aria-hidden="true" title="View Order"></i></a>&emsp;
                                    <?php if($this->session->userdata('user_is_admin') == '1') { ?>
                                        <a href="#" onclick="javascript : deleteConfirm('<?php echo site_url("admin/order/delete/".$order['cart_id']); ?>')"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php } ?>
