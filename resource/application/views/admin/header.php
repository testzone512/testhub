<div class="headerpanel">
    ...
    <div class="logopanel">
      <h2><a href="<?php echo site_url('admin/login/home'); ?>">Clothesloop</a></h2>
    </div><!-- logopanel -->
          ...
          <li>
            <div class="btn-group">
              <button type="button" class="btn btn-logged" data-toggle="dropdown">
                <img src="<?php echo site_url().'public/upload/profile/thumb/'.$this->session->userdata('user_profile_pic');?>" alt="Profile Image" />
              ...
              <ul class="dropdown-menu pull-right">
                <li><a href="<?php echo site_url('admin/profile/editProfile/'.$this->session->userdata('user_id')); ?>"><i class="glyphicon glyphicon-user"></i> My Profile</a></li>
