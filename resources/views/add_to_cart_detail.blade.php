...
<link rel="stylesheet" type="text/css" href="<?php echo url('public/front/css/product-details.css'); ?>" media="all">
<script src="<?php echo url('public/admin/js/jquery-1.10.2.js'); ?>"></script>
<link href="<?php echo url('public/front/bxslider/jquery.bxslider.css'); ?>" rel="stylesheet" />
<script src="<?php echo url('public/front/bxslider/jquery.bxslider.js'); ?>"></script>
<script src="<?php echo url('public/front/bxslider/jquery.bxslider.min.js'); ?>"></script>
<script src="<?php echo url('public/front/js/jquery.elevatezoom.js'); ?>"></script>
<script>
...
<script>
    $(document).ready(function(){
        $("#sltsize").change(function(){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo url('cart/ajax_size_found_in_tempcart'); ?>",
                data: {"_token": "{{ csrf_token() }}",sltsize: sltsize,product_id:product_id},
                dataType: 'text',
                success: function (data)
                {
                    if(data == "user_not_login")
                    {
                        $("#target").html('<a id="goto_cart" href="<?php echo url('login'); ?>">Go TO CART</a>');
                    }
                    if(data =="true")
                    {
                        $("#target").html('<a id="goto_cart" href="<?php echo url('cart/shopping_cart'); ?>">Go TO CART</a>');
                    }
                    else
                    {
...
<form class="form-horizontal" id="frmAddToCart" name="frmAddToCart" role="form" method="POST" action="{{ url('cart/temp_add_cart') }}">
    {{ csrf_field() }}
<div class="container">
    ...
    <div class="row">
            ...
            <div class="row" >
                <div class="col-sm-12">
                    <ul class="bxslider">
                        ...
                        {
                        ?>
                        <li><img class="img1 img-responsive" src="<?php echo url('public/upload/product').'/'.$pval['product_image']; ?>" data-zoom-image="<?php echo url('public/upload/product/thumb').'/'.$pval['product_image']; ?>" /></li>
                        <?php
                        }
                        ...
                        {
                        ?>
                        <li><img class="img1 img-responsive" src="<?php echo url('public/upload/gallery').'/'.$gval['gallery_image']; ?>" data-zoom-image="<?php echo url('public/upload/gallery/thumb').'/'.$gval['gallery_image']; ?>" /></li>
                        <?php
                        }
                        }
                        }
                ...
                <div class="col-sm-12 sub-pro-imgs">
                    <div id="bx-pager" class="sub-img">
                        ...
                        {
                        ?>
                        <a data-slide-index="<?php echo $count; ?>" href=""><img  src="<?php echo url('public/upload/product/thumb').'/'.$pval['product_image']; ?>" /></a>
                        <?php
                        $count=1;
                        }
                        foreach($galleryDetails as $gval)
                        ...
                        {
                        ?>
                        <a data-slide-index="<?php echo $count; ?>" href=""><img   src="<?php echo url('public/upload/gallery/thumb').'/'.$gval['gallery_image']; ?>" /></a>
                        <?php $count++;
                        }
                        }
                        }
        ...
        <div class="col-sm-7 select-pro-detail poppinsregular">
            ...
            <?php if(Helpers::get_qty($productDetails[0]['product_id']) <= 0)
            {
            ?>
            ...
            <div class="row poppinssemibold">
                ...
                <div class="col-sm-5 pro-dets-textbox">
                    ...
                    <select name="sltcolour" class="poppinsregular form-control" id="sltcolour">
                        ...
                        ?>
                        <option value="<?php echo $colour; ?>"><?php echo ucfirst(Helpers::get_colour($colour)); ?></option>
                        <?php } ?>
                    </select>
                </div>
                <?php } ?>
                ...
                <div class="col-sm-5 pro-dets-textbox">
                    ...
                    <select name="sltsize" class="poppinsregular form-control" id="sltsize" data_size="<?php echo $productDetails[0]['product_id']; ?>">
                        ...
                        ?>
                        <option  value="<?php echo $productSize['size_id']; ?>"><?php echo ucwords(Helpers::get_product_size($productSize['size_id'])); ?></option>
                        <?php } ?>
                    </select>
                </div>
                <?php } ?>
            ...
            <div class="row poppinssemibold">
                ...
                <div class="col-sm-5 pro-dets-textbox">
                    ...
                    <select name="sltqty" class="poppinsregular form-control" id="sltqty">
                        ...
                        <?php
                        for ($i = 1; $i<= Helpers::get_qty($productDetails[0]['product_id']); $i++)
                        {
                        ?>
