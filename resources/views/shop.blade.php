...
<script>
    function ajax_pagination(page)
    {
        ...
        if(page != "")
        {
            $.ajax({
                type: "POST",
                url: "<?php echo url('shop/ajax_pagination'); ?>",
            ...
            <div class="row pro-list"  id="ourHolder">
                ...
                <div class="col-sm-4 col-xs-4 product <?php echo $shop['category_name']; ?> <?php echo $shop['size_name']; ?>">
                    <div class="main-product-img" >
                        <a href="<?php echo url('shop/view').'/'.$shop['product_id']; ?>"><img src="<?php echo url('public/upload/product').'/'.$shop['product_image']; ?>" class="img-responsive" alt=""></a>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="main-pro-details" >
                                    ...
                                    <h4 class="main-size-pro poppinsregular " >Available:<?php echo Helpers::get_size($shop['product_id']); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
