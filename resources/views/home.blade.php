...
<link href="{{ URL::asset('public/front/bxslider/jquery.bxslider.css') }}" rel="stylesheet" />
<script src="{{ URL::asset('public/front/bxslider/jquery.bxslider.js') }}"></script>
<script src="{{ URL::asset('public/front/bxslider/jquery.bxslider.min.js') }}"></script>
<script src="{{ URL::asset('public/front/js/jquery.elevatezoom.js') }}"></script>
 <style>
 .bx-controls{
	 display:block;
 }
...
<div class="row">
	<div class="col-sm-12 col-xs-12">
		<ul class="bxslider">
			...
			$count++;
			?>
			<li><img src="<?php echo URL::asset('public/upload/slider/').'/'.$slider['slider_image'];?>" class="img-responsive" />
				<div class="row">
		...
		<div class="row main-display-product poppinssemibold ">
			...
			<div class="process-content">
				...
				<div class="col-sm-3 col-xs-6 Aenean-1">
					<img src="<?php echo url('public/front/images/process_logo1.png');?>" alt="process-logo1">
				...
				<div class="col-sm-3 col-xs-6 Aenean-2">
					<img src="<?php echo url('public/front/images/process_logo2.png');?>" alt="process-logo2">
					<h5><b>Aenean venenatis et</b></h5>
					<h6 class="poppinsregular" >Vestibulum ante ipsum primis in faucibus orci luctus et ultrices</h6>
				</div>
				<div class="col-sm-3 col-xs-12 Aenean-3">
					<img src="<?php echo url('public/front/images/process_logo3.png');?>" alt="process-logo3">
					<h5><b>Aenean venenatis et</b></h5>
					<h6 class="poppinsregular" >Vestibulum ante ipsum primis in faucibus orci luctus et ultrices</h6>
				</div>
			...
			<div class="seal-pro">
				<div class="col-sm-4 col-xs-6 product-1">
					<div class="product-img">
						<img src="<?php echo url('public/upload/product/').'/'.$productRandDetails[0]['product_image']; ?>" class="img-responsive " alt="Product1">
					</div>
					<div class="product-content">
						...
						<div class="pro-details ">
							...
							<h4 class="size-pro poppinsregular">Available:<?php Helpers::get_size($productRandDetails[0]['product_id']);?></h4>
						</div>
					</div>
				</div>
				<div class="col-sm-4 col-xs-6 product-3">
					<div class="product-img">
						<img src="<?php echo url('public/upload/product').'/'.$productRandDetails[1]['product_image']; ?>" class="img-responsive" alt="Product3">
					</div>
					<div class="product-content">
						<div class="sale-p">
						...
						<div class="pro-details">
							...
							<h4 class="size-pro poppinsregular">Available:<?php Helpers::get_size($productRandDetails[1]['product_id']);?></h4>
						</div>
					</div>
				</div>
				<div class="col-sm-4 col-xs-12 product-2">
					<div class="seal-pro-main">
						<div class="product-img2">
							<img src="<?php echo url('public/front/images/Clothesloop Website-1.jpg');?>" class="img-responsive" alt="Product2">
						</div>
						<div class="product-content2">
							...
							<div class="row">
								<img src="<?php echo url('public/front/images/sale-pro-details1.png');?>" alt="" class="sale-pro-details1 img-responsive">
							</div>
							<div class="row">
		...
		<div class="row seal-pro2">
			...
			<div>
				<div class="col-sm-4 col-xs-6 product-4">
					<div class="product-img">
						<img src="<?php echo url('public/upload/product').'/'.$productRandDetails[2]['product_image']; ?>" class="img-responsive" alt="Product4">
					</div>
					<div class="product-content">
						<div class="sale-p">
						...
						<div class="pro-details">
							...
							<h4 class="size-pro poppinsregular">
								Available:<?php Helpers::get_size($productRandDetails[2]['product_id']);?></h4>
						</div>
					</div>
				</div>
				<div class="col-sm-4 col-xs-6 product-6">
					<div class="product-img">
						<img src="<?php echo url('public/upload/product').'/'.$productRandDetails[3]['product_image']; ?>" class="img-responsive" alt="Product6">
					</div>
					<div class="product-content">
						<div class="sale-p">
						...
						<div class="pro-details">
							...
							<h4 class="size-pro poppinsregular">Available:<?php Helpers::get_size($productRandDetails[3]['product_id']);?></h4>
						</div>
					</div>
				</div>
	...
	<div class="container">
		<div class="row poppinssemibold ">
			<div class="col-sm-8 col-xs-12 our-mission-content ">
				...
				<img src="<?php echo url('public/front/images/lady-content-image.jpg');?>" class="img-responsive" alt="">
			...
			<div class="col-sm-4 col-xs-12 lady-image-content">
				<img src="<?php echo url('public/front/images/lady.png');?>" class="lady_image" alt="">
			</div>
		</div>
	</div>
</div>
...
<div class="pro-content">
	<div class="container">
		...
		<div class="row pros-content">
			<div class="col-sm-3 col-xs-6 offer-pro">
				<div class="offer-pro-img">
                    <a href="<?php echo url('shop/view/').'/'.$productRecentDetails[0]['product_id']; ?>"><img src="<?php echo url('public/upload/product');?>/<?php if(!empty($productRecentDetails[0]['product_image'])) {  echo $productRecentDetails[0]['product_image']; } ?>" class="img-responsive" alt="No Product Available"></a>
				</div>
				<div class="offer-pro-name">
					...
					<div class="offer-pro-details">
						...
						<h5 class="size-pro-offer poppinsregular ">Available:<?php Helpers::get_size($productRecentDetails[0]['product_id']);?></h5>
					</div>
				</div>
			</div>
			<div class="col-sm-3 col-xs-6">
				<div class="offer-pro-img">
                    <a href="<?php echo url('shop/view/').'/'.$productRecentDetails[1]['product_id']; ?>"><img src="<?php echo url('public/upload/product');?><?php if(!empty($productRecentDetails[1]['product_image'])) {  echo '/'.$productRecentDetails[1]['product_image']; } ?>" class="img-responsive" alt="No Product Available"></a>
				</div>
				<div class="offer-pro-name">
					...
					<div class="offer-pro-details">
						...
						<h5 class="size-pro-offer poppinsregular ">Available:<?php Helpers::get_size($productRecentDetails[1]['product_id']);?></h5>
					</div>
				</div>
			</div>
			<div class="col-sm-3 col-xs-6">
				<div class="offer-pro-img">
                    <a href="<?php echo url('shop/view/').'/'.$productRecentDetails[2]['product_id']; ?>"><img src="<?php echo url('public/upload/product');?><?php if(!empty($productRecentDetails[2]['product_image'])) {  echo '/'.$productRecentDetails[2]['product_image']; } ?>" class="img-responsive" alt="No Product Available"></a>
				</div>
				<div class="offer-pro-name">
					...
					<div class="offer-pro-details">
						...
						<h5 class="size-pro-offer poppinsregular">Available:<?php Helpers::get_size($productRecentDetails[2]['product_id']);?></h5>
					</div>
				</div>
			</div>
			<div class="col-sm-3 col-xs-6">
				<div class="offer-pro-img">
                    <a href="<?php echo url('shop/view/').'/'.$productRecentDetails[3]['product_id']; ?>"><img src="<?php echo url('public/upload/product');?><?php if(!empty($productRecentDetails[3]['product_image'])) {  echo '/'.$productRecentDetails[3]['product_image']; } ?>" class="img-responsive" alt="No Product Available"></a>
				</div>
				<div class="offer-pro-name">
					...
					<div class="offer-pro-details">
						...
						<h5 class="size-pro-offer poppinsregular">Available:<?php Helpers::get_size($productRecentDetails[3]['product_id']);?></h5>
					</div>
				</div>
			</div>
		</div>
		<div class="row pro-sample">
			<div class="col-sm-3 col-xs-6">
				<div class="offer-pro-img">
                    <a href="<?php echo url('shop/view/').'/'.$productRecentDetails[4]['product_id']; ?>"><img src="<?php echo url('public/upload/product');?><?php if(!empty($productRecentDetails[4]['product_image'])) {  echo '/'.$productRecentDetails[4]['product_image']; } ?>" class="img-responsive" alt="No Product Available"></a>
				</div>
				<div class="offer-pro-name">
					...
					<div class="offer-pro-details">
						...
						<h5 class="size-pro-offer poppinsregular">Available:<?php Helpers::get_size($productRecentDetails[4]['product_id']);?></h5>
					</div>
				</div>
			</div>
			<div class="col-sm-3 col-xs-6">
				<div class="offer-pro-img">
                    <a href="<?php echo url('shop/view/').'/'.$productRecentDetails[5]['product_id']; ?>"><img src="<?php echo url('public/upload/product/');?><?php if(!empty($productRecentDetails[5]['product_image'])) {  echo '/'.$productRecentDetails[5]['product_image']; } ?>" class="img-responsive" alt="No Product Available"></a>
				</div>
				<div class="offer-pro-name">
					...
					<div class="offer-pro-details">
						...
						<h5 class="size-pro-offer poppinsregular">Available: <?php Helpers::get_size($productRecentDetails[5]['product_id']);?></h5>
					</div>
				</div>
			</div>
			<div class="col-sm-3 col-xs-6">
				<div class="offer-pro-img">
                    <a href="<?php echo url('shop/view/').'/'.$productRecentDetails[6]['product_id']; ?>"><img src="<?php echo url('public/upload/product');?><?php if(!empty($productRecentDetails[6]['product_image'])) {  echo '/'.$productRecentDetails[6]['product_image']; } ?>" class="img-responsive" alt="No Product Available"></a>
				</div>
				<div class="offer-pro-name">
					...
					<div class="offer-pro-details">
						...
						<h5 class="size-pro-offer poppinsregular">Available:<?php Helpers::get_size($productRecentDetails[6]['product_id']);?></h5>
					</div>
				</div>
			</div>
			<div class="col-sm-3 col-xs-6">
				<div class="offer-pro-img">
                    <a href="<?php echo url('shop/view/').'/'.$productRecentDetails[7]['product_id']; ?>"><img src="<?php echo url('public/upload/product');?><?php if(!empty($productRecentDetails[7]['product_image'])) {  echo '/'.$productRecentDetails[7]['product_image']; } ?>" class="img-responsive" alt="No Product Available"></a>
				</div>
				<div class="offer-pro-name">
					...
					<div class="offer-pro-details">
						...
						<h5 class="size-pro-offer poppinsregular">Available:<?php Helpers::get_size($productRecentDetails[7]['product_id']);?></h5>
					</div>
				</div>
			</div>
		</div>
