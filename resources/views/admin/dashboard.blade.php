        ...
        <div class="col-md-9 col-lg-8 dash-left">
          ...
          <div class="row panel-quick-page">
            <div class="col-xs-4 col-sm-5 col-md-4 page-user">
              <div class="panel">
                <div class="panel-heading">
                  <h4 class="panel-title"><a href="<?php echo url('admin/user'); ?>">Manage Users</a></h4>
                </div>
                <div class="panel-body">
                  <div class="page-icon"><a title="Users" href="<?php echo url('admin/user'); ?>"><i class="icon ion-person-stalker"></i></a></div>
                </div>
              </div>
            </div>
          ...
          <div class="col-xs-4 col-sm-4 col-md-4 page-products">
             <div class="panel">
               <div class="panel-heading">
                 <h4 class="panel-title"><a href="<?php echo url('admin/product'); ?>">Manage Products</a></h4>
               </div>
               <div class="panel-body">
                 <div class="page-icon"><a title="Product" href="<?php echo url('admin/product'); ?>"><i class="fa fa-shopping-cart"></i></a></div>
               </div>
             </div>
           </div>
            ...
            <div class="col-xs-4 col-sm-3 col-md-2 page-events">
              <div class="panel">
                <div class="panel-heading">
                  <h4 class="panel-title"><a href="<?php echo url('admin/order'); ?>">Order</a></h4>
                </div>
                <div class="panel-body">
                  <div class="page-icon"><a title="Order" href="<?php echo url('admin/order'); ?>"><i class="icon ion-ios-calendar-outline"></i></a></div>
                </div>
              </div>
            </div>
            <div class="col-xs-4 col-sm-3 col-md-2 page-messages">
              <div class="panel">
                <div class="panel-heading">
                  <h4 class="panel-title"><a href="<?php echo url('admin/shipping'); ?>">Shipping</a></h4>
                </div>
                <div class="panel-body">
                  <div class="page-icon"><a title="Shipping" href="<?php echo url('admin/shipping'); ?>"><i class="icon ion-arrow-graph-up-right"></i></a></div>
                </div>
              </div>
            </div>
