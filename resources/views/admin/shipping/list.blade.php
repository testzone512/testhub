...
<div class="form-group">
    <div class="row"><!-- row START -->
        <div class="col-lg-12">
            ...
            <a href="<?php echo url('/admin/shipping/add'); ?>" class="btn btn-primary btn-quirk btn-stroke pull-right">Add Shipping</a>
            <?php } ?>
        </div>
    </div><!-- row END -->
</div>
                ...
                <div class="panel-body">
                    <table class="table table-bordered" id="shippingData">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if(Session::get('admin_sess_is_admin')==1){ ?>
                                <a href="<?php echo url('/admin/shipping/edit/' . $shipping["shipping_id"]); ?>"><i class="fa fa-pencil fa-2x" aria-hidden="true" title="Edit Shipping"></i></a>&emsp;
                                <a href="#" onclick="javascript : deleteConfirm('<?php echo url("/admin/shipping/delete/" . $shipping['shipping_id']); ?>')"><i class="fa fa-trash fa-2x" aria-hidden="true" title="Delete Shipping"></i></a>
                                <?php } ?>
                            </td>
                        </tr>
                        <?php } ?>
