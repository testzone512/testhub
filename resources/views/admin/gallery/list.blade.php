...
<script>
    function ajax_gallery_active_inactive(Action,GalleryId)
    {
        if(Action != "" && GalleryId !="")
        {
            $.ajax({
                type: "POST",
                url: "<?php echo url('/admin/gallery/ajax_gallery_active_inactive'); ?>",
                data: {"_token": "{{ csrf_token() }}",Action: Action, GalleryId : GalleryId},
                dataType: 'text',
...
<div class="form-group">
	<div class="row"><!-- row START -->
        ...
        <div lass="col-lg-1">
            ...
            <a  href="<?php echo url('admin/gallery/add'); ?><?php echo '/'.$product_id; ?>"  class="btn btn-primary btn-quirk btn-stroke">Add Gallery </a>
            <?php } ?>
        </div>
	</div><!-- row END -->
</div>
                            ...
                            foreach ($galleryDetails as $gallery) {
                                ...
                                <tr class="gradeA">
                                    ...
                                    <td><?php  if($gallery['gallery_image']!='')
                                        { ?>
                                            <img src="<?php echo url('public/upload/gallery/thumb')?> <?php echo '/'.$gallery['gallery_image'];?>" width="100" align="left"/>
                                            <?php
                                        }
                                        else
                                        { ?>
                                    ...
                                    <td>
                                        ...
                                        <a title="Edit Gallery"  href="<?php echo url('admin/gallery/edit'); ?><?php echo '/'.$gallery['gallery_id']; ?>" style="text-decoration:none;"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i></a>&nbsp;
                                        <?php
                                        ...
                                        ?>
                                        <a title="Delete Gallery"  href="#" onclick="javascript : deleteConfirm('<?php echo url('admin/gallery/delete'); ?><?php echo '/'.$gallery['gallery_id']; ?>')" style="text-decoration:none;"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></a></td>
                                        <?php } ?>
                                </tr>
                                <?php $i++; } ?>
