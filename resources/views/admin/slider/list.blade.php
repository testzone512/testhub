...
<div class="form-group">
    <div class="row"><!-- row START -->
        <div class="col-lg-12">
            ...
            <a href="<?php echo url('admin/slider/add'); ?>" class="btn btn-primary btn-quirk btn-stroke pull-right">Add Slider</a>
            <?php } ?>
        </div>
    </div><!-- row END -->
</div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sliderData">
                            ...
                            <tr class="gradeA">
                                <td>
                                    ...
                                    <img src="<?php echo url('public/upload/slider/thumb').'/'.$slider['slider_image'];?>" width="100" align="left"/>
                                    <?php } else { ?>
                                ...
                                <td>
                                    <?php if(Session::get('admin_sess_is_admin')==1){ ?>
                                    <a title="Edit Gallery"  href="<?php echo url('admin/slider/edit').'/'.$slider['slider_id']; ?>" style="text-decoration:none;"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i></a>&nbsp;
                                    <a title="Delete Gallery"  href="#" onclick="javascript : deleteConfirm('<?php echo url('admin/slider/delete').'/'.$slider['slider_id']; ?>')" style="text-decoration:none;"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></a></td>
                                    <?php } ?>
                            </tr>
                            <?php } ?>
