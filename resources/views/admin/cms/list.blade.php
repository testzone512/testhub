...
<div class="form-group">
    <div class="row"><!-- row START -->
        ...
        <div lass="col-lg-1">
            ...
            <a  href="<?php echo url('admin/cms/add'); ?>"  class="btn btn-primary btn-quirk btn-stroke">Add Cms </a>
            <?php } ?>
        </div>
    </div><!-- row END -->
</div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered " id="example">
                            ...
                            <tr class="gradeA">
                                ...
                                <td>
                                    <?php if(Session::get('admin_sess_is_admin')==1){ ?>
                                        <a title="Edit Cms"  href="<?php echo url('admin/cms/edit'); ?><?php echo '/'.$cms['cms_id']; ?>" style="text-decoration:none;"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i></a>&nbsp;
                                    <?php } ?>
                                    <a title="View Cms" href="<?php echo url('admin/cms/view'); ?><?php echo '/'.$cms['cms_id']; ?>"><i class="fa fa-eye fa-2x" aria-hidden="true"></i></a>
                                    <?php if(Session::get('admin_sess_is_admin')==1){ ?>
                                        <a title="Delete Cms"  href="#" onclick="javascript : deleteConfirm('<?php echo url('admin/cms/delete'); ?><?php echo '/'.$cms['cms_id']; ?>')" style="text-decoration:none;"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></a>
                                    <?php } ?>
                                </td>
                            </tr>
                            <?php $i++; } ?>
