...
<script>
    $(document).ready(function(){
        $(".sltqty").change(function(){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo url('cart/ajax_temp_update_qty_cart'); ?>",
                data: {"_token": "{{ csrf_token() }}",cart_id: cart_id,qty:qty,price:price},
                dataType: 'text',
                ...
                <tr>
                    ...
                    <td>
                        <select name="sltqty" class="sltqty" data_price="<?php echo $shop['tc_product_price']; ?> " id="<?php echo $shop['tc_id'];?>">
                            <?php
                            for ($i = 1; $i<= Helpers::get_qty($shop['tc_product_id'])+$shop['tc_product_qty']; $i++)
                            {
                            ?>
                        ...
                        <a href="#" onclick="javascript : deleteConfirm('<?php echo url("cart/delete_shop_product/").'/'.$shop['tc_id']; ?>')"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></a>
                    </td>
    ...
    <div class="row" style="border: 1px solid #eeeeee; margin-top: 1%; padding: 2%;">
        <div class="col-xs-12">
            ...
            <div style="float:right;">
                ...
                {
                ?>
                <a href="<?php echo url('cart/delivery_deatil'); ?>" style="border: 1px solid #080808; padding: 5px 10px;">Checkout <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                <?php
                }
                else
                {
