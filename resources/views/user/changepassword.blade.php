        ...
        $("#frmChangePassword").validate({
            rules:
            {
                txtOldPassword:
                {
                    required:true,
                    remote: {
                        url: "<?php echo url('register/isOldPasswordMatch'); ?>",
                        type: "post",
                ...
                txtNewPassword:
                {
                    ...
                    minlength: 6,
                    remote: {
                        url: "<?php echo url('register/isOldAndNewPasswordDiffrent'); ?>",
                        type: "post",
                        data: {"_token": "{{ csrf_token() }}",
...
<div class="container">
    <div class="reg-main-cont">
        ...
        <form method="post" name="frmChangePassword" id="frmChangePassword" action="{{ url('register/changePassword') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-sm-12 first-details">
                        <div class="orders">
                            ...
                            <a href="<?php echo url('register/changePassword/'); ?>" class="poppinssemibold active"><i class="fa fa-angle-double-right" aria-hidden="true"></i>&emsp;Change Password</a><br/>
            ...
            <div class="col-sm-8 first-details">
                <div class="row">
                    <div class="col-sm-12 register-textbox">
                        ...
                        <input type="password" name="txtOldPassword" id="txtOldPassword" class="form-control required">
                    ...
                    <div class="col-sm-12 register-textbox">
                        ...
                        <input type="password" name="txtConfirmPassword" id="txtConfirmPassword" class="form-control required">
                    </div>
