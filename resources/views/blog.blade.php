        ...
        <div class="container">
            <div class="row post-DC">
                            ...
                            <div class="col-sm-6 col-xs-6 blog-post-content">
                                <style type="text/css">
                                    .blogs-img<?php echo $blog['blog_id']; ?> {
                                        background-image:url(<?php echo url('public/upload/blog/thumb').'/'.$blog['blog_image']; ?>);
                                ...
                                <div>
                                    <img src="<?php echo url('public/upload/blog/thumb').'/'.$blog['blog_image']; ?>" class="img-responsive" alt="" />
                                </div>
                                <div class="post-main-content">
                                    ...
                                    <a href="<?php echo url('blogView').'/'.$blog['blog_id']; ?>"><button class="post-button poppinssemibold">READ MORE</button></a>
                                </div>
                            </diV>
                        <?php } ?>
                    </div>
                ...
                <div class="col-sm-4 col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-6 recent-post">
                            <img src="<?php echo url('public/front/images/Clothesloop Website-7.jpg'); ?>" class="img-responsive" alt="recent-blog">
                        </div>
                    </div>
                </div>
            </div>
