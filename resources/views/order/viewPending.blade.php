...
<div class="container">
    <div class="reg-main-cont">
        ...
        <form method="post" name="frmPendingOrder" id="frmPendingOrder" action="{{ url('register/edit') }}<?php echo '/'.$viewPendingOrder[0]['id']; ?>" enctype="multipart/form-data">
            ...
            <div class="col-sm-8  first-details">
                <div class="row">
                    <div class="col-sm-12  register-textbox">
                        <a href="<?php echo url('order/pending_order_list'); ?>" class="back poppinssemibold">Back to Order</a>
                        <table class="table table-bordered table-responsive try">
                            <tr>
                                <th>User Name</th>
                                <td>&nbsp; <?php echo $viewPendingOrder[0]['name'];?></td>
                            </tr>
                            <tr>
                                <th>Product Name</th>
                                <td><?php echo $viewPendingOrder[0]['cart_product_name']; ?></td>
                            </tr>
                            <tr>
                                <th>Address</th>
                                <td><?php echo $viewPendingOrder[0]['address1']; ?></td>
                            </tr>
                            <tr>
                                <th>Product Price</th>
                                <td><?php echo $viewPendingOrder[0]['cart_product_price']; ?></td>
                            </tr>
                            <tr>
                                <th>Product Quantity</th>
                                <td><?php echo $viewPendingOrder[0]['cart_product_qty']; ?></td>
                            </tr>
                            <tr>
                                <th>Product Image</th>
                                <td>
                                    <?php if($viewPendingOrder[0]['cart_product_img'] != '') { ?>
                                    <img src="<?php echo url('public/upload/product/thumb').'/'.$viewPendingOrder[0]['cart_product_img']; ?>" style="height: 100px; width: 100px;" class="img-responsive">
                                    <?php } else { ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $viewPendingOrder[0]['colour_name']; ?></td>
                            </tr>
                            <tr>
                                <th>Product Size</th>
                                <td><?php echo $viewPendingOrder[0]['size_name']; ?></td>
                            </tr>
                            <tr>
                                <th>Product Total</th>
                                <td><?php echo $viewPendingOrder[0]['cart_product_total']; ?></td>
                            </tr>
                            <tr>
                                <th>Order Status</th>
                                <td><?php echo $viewPendingOrder[0]['cart_order_status']; ?></td>
                            </tr>
                            <tr>
                                <th>Created On</th>
                                <td><?php echo $viewPendingOrder[0]['cart_created_on']; ?></td>
                            </tr>
                        </table>
                    </div>
