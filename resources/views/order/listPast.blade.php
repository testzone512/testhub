...
<div class="container">
    <div class="reg-main-cont">
        <div class="row register-head">
           ...
           <form method="post" name="frmPendingOrder" id="frmPendingOrder" action="" enctype="multipart/form-data">
                        ...
                        <table class="table table-bordered table-responsive">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <img src="<?php echo url('public/upload/product').'/'.$pastOrder['cart_product_img']; ?>" style="height: 100px; width: 100px;" class="img-responsive">
                                    <?php } else { ?>
                                    <img src="<?php echo url('public/upload/product/thumb/noPreview.png');?>">
                                    <?php } ?>
                                </td>
                                <td><?php $data = explode(' ',$pastOrder['name']) ; echo $data[0]; ?>&nbsp;<?php $data = explode(' ',$pastOrder['name']) ; echo $data[1]; ?></td>
                                <td><?php echo $pastOrder['cart_product_name']; ?></td>
                                <td><?php echo $pastOrder['cart_order_status']; ?></td>
                                <td><a href="<?php echo url('order/past_order_view').'/'.$pastOrder['cart_id']; ?>"><i class="fa fa-eye fa-lg" aria-hidden="true"></i></a></td>
                            </tr>
                            <?php } ?>
                            </tbody>
