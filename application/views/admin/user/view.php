  ...
  <div class="row profile-wrapper">
    ...
    <div class="col-xs-12 col-md-3 col-lg-2 profile-left">
      <div class="profile-left-heading">
        ...
        <a href="#" class="profile-photo"><img class="img-circle img-responsive" src="<?php if(!empty($userDetails[0]['user_profile_pic'])){ echo site_url().'public/upload/profile/thumb/'.$userDetails[0]['user_profile_pic']; } else { echo site_url().'public/admin/images/noprofile.jpg';}?>" alt="No Found"></a>
        ...
        <a href="<?php echo site_url('admin/user/edit/'.$userDetails[0]['user_id']); ?>" class="btn btn-danger btn-quirk btn-block profile-btn-follow">Edit Profile</a>
          ...
          <div class="tab-pane active" id="activity">
            <div class="panel panel-post-item">
              <div class="panel-heading">
                <div class="media">
                  <div class="media-left"> <a href="#"> <img alt="" src="<?php if(!empty($userDetails[0]['user_profile_pic'])){ echo site_url().'public/upload/profile/thumb/'.$userDetails[0]['user_profile_pic']; } else { echo site_url().'public/admin/images/noprofile.jpg';}?>" class="media-object img-circle"> </a> </div>
                  	<div class="media-body">
                    	<h4 class="media-heading"><?php if(!empty($userDetails[0]['user_firstname'])){ echo ucfirst($userDetails[0]['user_firstname']); }?>&nbsp;<?php if(!empty($userDetails[0]['user_lastname'])) { echo ucfirst($userDetails[0]['user_lastname']); } ?></h4>
                  	</div>
                </div>
                <!-- media --> 
              </div>
              ...
              <div class="form-group">
              	<div class="row">
                    ...
                    <div class="col-lg-4">
                    	<?php if(!empty($userDetails[0]['user_introduction'])){ echo $userDetails[0]['user_introduction']; } ?>
                    </div>
                </div>
              </div>
              ...
              <div class="form-group">
              	<div class="row">
                    ...
                    <div class="col-lg-4">
                    	<?php if(!empty($userDetails[0]['user_address'])){ echo $userDetails[0]['user_address']; }?>
                    </div>
                </div>
              </div>
              ...
              <div class="form-group">
              	<div class="row">
                    ...
                    <div class="col-lg-4">
                    	<?php if(!empty($userDetails[0]['user_mobile'])){ echo $userDetails[0]['user_mobile']; } ?>
                    </div>
                </div>
              </div>
              ...
              <div class="form-group">
              	<div class="row">
                    ...
                    <div class="col-lg-4">
                    	<?php if(!empty($userDetails[0]['user_email'])) { echo $userDetails[0]['user_email']; } ?>
                    </div>
                </div>
              </div>
