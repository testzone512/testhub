                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <img src="<?php echo base_url();?>public/upload/product/thumb/<?php echo $pendingOrder['cart_product_img']; ?>" style="height: 100px; width: 100px;" class="img-responsive">
                                        <?php } else { ?>
                                            <img src="<?php echo base_url();?>public/upload/product/thumb/noPreview.png">
                                        <?php } ?>
                                    </td>
                                    <td><?php echo $pendingOrder['user_firstname']; ?>&nbsp;<?php echo $pendingOrder['user_lastname']; ?></td>
                                    <td><?php echo $pendingOrder['cart_product_name']; ?></td>
                                    <td><?php echo $pendingOrder['cart_order_status']; ?></td>
                                    <td><a href="<?php echo site_url('order/pendingView/'.$pendingOrder['cart_id']); ?>"><i class="fa fa-eye fa-lg" aria-hidden="true"></i></a></td>
                                </tr>
                                <?php } ?>
                            </tbody>
