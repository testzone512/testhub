    ...
    $(document).ready(function(){
        $(".btnUpdate").click(function(){
            ...
            else
           {
               $.ajax({
                   type: "POST",
                   url: "<?php echo site_url('cart/ajax_delivery_deatil_update_user_address'); ?>",
            ...
            <div class="row" style="margin:5%;">
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-11"> <p><?php echo $deliveryDetails[0]['user_address']; ?></p></div>
                    </div>
                </div>
            </div>
    ...
    <div class="row" style="border: 1px solid #eeeeee; margin-top: 1%; padding: 2%;">
        <div class="col-xs-12">
            ...
            <div style="float:right;">
                    ...
                    {
                        ?>
                        <a href="<?php echo base_url(); ?>cart/payment" style="border: 1px solid #080808; padding: 5px 10px;">Checkout <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                        <?php
                    }
                    else
                    {
