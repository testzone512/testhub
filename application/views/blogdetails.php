		...
		<div class="row">
			...
			<div class="col-sm-8">
				<div class="more-details-img">
					<img src="<?php echo base_url(); ?>public/upload/blog/<?php echo $blog['blog_image']; ?>" class="img-responsive" alt="">
				</div>
				<div class="blog-details-content">
			...
			<div class="col-sm-4">
				...
				<div class="row">
					<div class="col-sm-12 recent-post">
						<img src="<?php echo base_url(); ?>public/upload/blog/thumb/<?php echo $blog['blog_image']; ?>" class="img-responsive" alt="recent-blog">
					</div>
				</div>
			</div>
		</div>
