...
<div class="form-group">
    <div class="row"><!-- row START -->
        <div class="col-sm-12">
            <a href="<?php echo base_url(); ?>admin/order/" class="btn btn-primary btn-quirk btn-stroke">Back Order List</a>
        </div>
    </div><!-- row END -->
</div>
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-11">
                            <?php echo ucfirst($viewOrder[0]['user_firstname']); ?> &nbsp;<?php echo ucfirst($viewOrder[0]['user_lastname']); ?>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-1">&nbsp;</div>
                        <div class="col-sm-11">
                            <?php echo $viewOrder[0]['user_address']; ?>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
              <div class="col-sm-12">
                  <table class="table">
                      ...
                      <tbody>
                      <?php
                      foreach(shipping_cost_order($id,$newDate) as $shop)
                      {
                          ?>
                          <tr>
                              <td style="width: 30%;">
                                  <div class="row">
                                      <div class="col-sm-6">
                                          <img src="<?php echo base_url(); ?>public/upload/product/thumb/<?php echo $shop['cart_product_img']; ?>" class="img-responsive" alt="">
                                      </div>
                                      ...
                                      <div class="col-sm-6">
                                          ...
                                          <?php if($shop['cart_product_colour']){ ?>
                                              <div class="row">
                                                  <div class="col-sm-12">Colour:&nbsp;<?php echo ucfirst(get_colour($shop['cart_product_colour'])); ?></div>
                                              </div>
                                          <?php } ?>
                                          <?php if(!empty($shop['cart_product_size'])){ ?>
                                              <div class="row">
                                                  <div class="col-sm-12">Size:&nbsp;<?php  echo ucwords(get_product_size($shop['cart_product_size'])); ?> </div>
                                              </div>
                                          <?php } ?>
                                      </div>
                                  </div>
