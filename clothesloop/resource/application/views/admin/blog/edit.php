    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-6">
                ...
                echo form_open_multipart('admin/blog/edit/'.$blogDetails[0]['blog_id'],$attributes);
                ?>
                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-5">
                                <?php if($blogDetails[0]['blog_image']!='') { ?>
                                    <img src="<?php echo site_url().'public/upload/blog/thumb/'.$blogDetails[0]['blog_image'];?>" width="100" align="left"/>
                                <?php } else { ?>
                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-5">
                                <?php $dataBlogTitle = array(
									...
									'id'          => 'txtBlogTitle',
									'class'		  => 'form-control',
									'value'		  => $blogDetails[0]['blog_title']
									);
							   ?>
                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-9">
                                <?php $dataBlogDescription = array(
									...
									'id'          => 'editor1',
									'class'		  => 'form-control',
									'value'		  => $blogDetails[0]['blog_description']
									);
							   ?>
                 ...
                 <div class="form-group">
                    <div class="row">
                            ...
                            <div class="col-sm-3">
							   ...
							   ?>
								<?php echo form_submit($dataSubmit,'Update Blog'); ?>
                            </div>
                     </div>
                 </div>      
                
                
                <?php echo form_hidden('blogEditImage',$blogDetails[0]['blog_image']); echo form_close(); ?>
