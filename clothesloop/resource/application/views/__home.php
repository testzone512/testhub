		...
		<div class="col-sm-12 col-xs-12">
			<ul class="bxslider">
				...
				foreach($sliderDetails as $slider)
				{
					$count++;
					?>
					<li><img src="<?php echo site_url().'public/upload/slider/'.$slider['slider_image'];?>" class="img-responsive" /></li>
				<?php
				} ?>
			</ul>
		</div>
	...
	<div class="container">
		<div class="row main-display-product poppinssemibold ">
			...
			<div class="process-content">
				<div class="col-sm-4 col-xs-6 Aenean-1">
			...
			<div class="seal-pro">
				<div class="col-sm-4 col-xs-6 product-1">
					<div class="product-img">
						<img src="<?php echo base_url();?>public/upload/product/<?php echo $productRandDetails[0]['product_image']; ?>" class="" alt="Product1">
					</div>
				...
				<div class="col-sm-4 col-xs-12 product-2">
					<div class="seal-pro-main">
						...
						<div class="product-content2">
							...
							<div class="row">
								<img src="images/sale-pro-details1.png" alt="" class="sale-pro-details1 img-responsive">
							</div>
							<div class="row">
	...
	<div class="container">
		<div class="row poppinssemibold ">
			...
			<div class="col-sm-4 col-xs-12 lady-image-content">
				<img src="<?php echo base_url();?>public/front/images/lady.png" class="lady_image img-responsive" alt="">
			</div>
		</div>
	</div>
</div>
<div class="testimonial">
	<div class="container">
		<div class="row poppinssemibold ">
			...
			<div class="col-sm-7 col-xs-8 testimonial-font testimonial-block2">
...
<div class="pro-content">
	<div class="container">
		...
		<div class="row pros-content">
			<div class="col-sm-3 col-xs-6 offer-pro">
				<div class="offer-pro-img">
					<img src="<?php echo base_url();?>public/upload/product/<?php if(!empty($productRecentDetails[0]['product_image'])) {  echo $productRecentDetails[0]['product_image']; } ?>" class="img-responsive" alt="No Product Available">
				</div>
			...
			<div class="col-sm-3 col-xs-6">
				<div class="offer-pro-img">
					<img src="<?php echo base_url();?>public/upload/product/<?php if(!empty($productRecentDetails[1]['product_image'])) {  echo $productRecentDetails[1]['product_image']; } ?>" class="img-responsive" alt="No Product Available">
				</div>
				<div class="offer-pro-name">
			...
			<div class="col-sm-3 col-xs-6">
				<div class="offer-pro-img">
					<img src="<?php echo base_url();?>public/upload/product/<?php if(!empty($productRecentDetails[2]['product_image'])) {  echo $productRecentDetails[2]['product_image']; } ?>" class="img-responsive" alt="No Product Available">
				</div>
				<div class="offer-pro-name">
			...
			<div class="col-sm-3 col-xs-6">
				<div class="offer-pro-img">
					<img src="<?php echo base_url();?>public/upload/product/<?php if(!empty($productRecentDetails[3]['product_image'])) {  echo $productRecentDetails[3]['product_image']; } ?>" class="img-responsive" alt="No Product Available">
				</div>
				<div class="offer-pro-name">
		...
		<div class="row pro-sample">
			<div class="col-sm-3 col-xs-6">
				<div class="offer-pro-img">
					<img src="<?php echo base_url();?>public/upload/product/<?php if(!empty($productRecentDetails[4]['product_image'])) {  echo $productRecentDetails[4]['product_image']; } ?>" class="img-responsive" alt="No Product Available">
				</div>
				<div class="offer-pro-name">
			...
			<div class="col-sm-3 col-xs-6">
				<div class="offer-pro-img">
					<img src="<?php echo base_url();?>public/upload/product/<?php if(!empty($productRecentDetails[5]['product_image'])) {  echo $productRecentDetails[5]['product_image']; } ?>" class="img-responsive" alt="No Product Available">
				</div>
				<div class="offer-pro-name">
			...
			<div class="col-sm-3 col-xs-6">
				<div class="offer-pro-img">
					<img src="<?php echo base_url();?>public/upload/product/<?php if(!empty($productRecentDetails[6]['product_image'])) {  echo $productRecentDetails[6]['product_image']; } ?>" class="img-responsive" alt="No Product Available">
				</div>
				<div class="offer-pro-name">
			...
			<div class="col-sm-3 col-xs-6">
				<div class="offer-pro-img">
					<img src="<?php echo base_url();?>public/upload/product/<?php if(!empty($productRecentDetails[7]['product_image'])) {  echo $productRecentDetails[7]['product_image']; } ?>" class="img-responsive" alt="No Product Available">
				</div>
				<div class="offer-pro-name">
