       ...
       $("#frmDeactivateAccount").validate({
		 rules:
		 {
			 txtPassword:
			 {
				 required:true,
                 remote: {
                       url: "<?php echo base_url('register/isAccountDeactivatePasswordMatch'); ?>",
                       type: "post",
                       data: {
                           name: function() {
...
<div class="container">
	<div class="reg-main-cont">
        ...
        <?php 
            $attributes = 'id="frmDeactivateAccount"';
            echo form_open('register/deactivateAccount/',$attributes);
        ?>
                ...
                <div class="form-group row">
                    <div class="col-sm-12 first-details">
                        <div class="orders">
                            ...
                            <a href="<?php echo site_url('register/deactivateAccount/'); ?>" class="poppinssemibold active"><i class="fa fa-angle-double-right" aria-hidden="true"></i>&emsp;Deactivate Account</a><br/>
			...
			<div class="col-sm-8 first-details">
				<div class="row">
                    <div class="col-sm-12 register-textbox">
                        ...
                        <b><?php echo $this->session->userdata('front_user_email'); ?></b>
					</div>
					<div class="col-sm-12 register-textbox">
                    ...
                    <div class="col-sm-12">
                        <input type="submit" name="btnDeactivate" id="btnDeactivate" class="editprofile-label poppinssemibold btnregister" value="Deactivate Account"></input>
					</div>
