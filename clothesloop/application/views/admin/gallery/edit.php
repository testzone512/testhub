...
<div class="form-group">
	<div class="row"><!-- row START -->
		<div class="col-lg-12">
			<a href="<?php echo base_url(); ?>admin/gallery/list_gallery/<?php echo $GalleryDetails[0]['gallery_product_id']; ?>" class="btn btn-primary btn-quirk btn-stroke">Back Product Gallery List</a>
		</div>
	</div><!-- row END -->
</div>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-lg-6">
                ...
                echo form_open_multipart('admin/gallery/edit/'.$GalleryDetails[0]['gallery_id'],$attributes);
                ?>
                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-3">
                               <?php $dataGalleryImage = array(
                    			...
                    			<span id="gi"></span>
                    			<img height="119" width="180" alt="" src="<?php echo site_url()."public/upload/gallery/".$GalleryDetails[0]['gallery_image'];?>">
                            </div>
                     </div>
                 </div>   
